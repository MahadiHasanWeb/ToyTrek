import { FaFacebook, FaInstagram, FaTwitter, FaGithub, FaGrav } from "react-icons/fa";
            ...
            <div className=" mx-auto">
                ...
                <footer className="p-4 bg-white sm:p-6 dark:bg-gray-800">
                    ...
                    <div className="sm:flex sm:items-center sm:justify-between">
                        <span className="text-lg text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a className="hover:underline">ToyTrek™</a>. All Rights Reserved.
                        </span>
